...
public class A_Variable {
	...
	public void printValue() {
		...
		// 변수를 사용하지 않으면
		System.out.println(10 * 2 * 3.141592); // 원의 둘레 = 반지름 x 2 x 파이
		System.out.println(10 * 10 * 3.141592); // 원의 넓이 = 반지름 x 반지름 x 파이
...
//		isFalse = 1; // 에러발생 (true 와 false 만 가능)
...
//		bNum = 128; // 에러 발생 -> 오버플로우(Overflow)
		lNum = 135456498489L; // 숫자 뒤에 L 또는 l을 입력해야 한다.
...
//		int void;
		...
		// 5) (권장사항) 낙타표기법 (카멜케이스)
		// -첫글자는 항상 소문자 단어가 바뀔 때 마다 대문자로 시작
	...
	public void constant() {
		 ...
		 * [표현법] final 자료형 변수명;
		 * 
		 * - 변하지 않는 값으로 특정 변수의 값이 변경되는 걸 원하지 않을 떄 사용한다.
