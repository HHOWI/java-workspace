...
//		f.method2();
	...
	public void method1() {
		// BufferedReader : 버퍼는 데이터가 쌓이기를 기다렸다가 꽉 차게 되면 데이터를 한번에 보냄
	...
	public void method2() {
		/*
		 * BufferedReader, BufferdWriter : 입출력 효율을 높이기 위해 버퍼를 사용하는 보조스트림 - 라인(line) 단위로
		 * 입출력이 편리 - String readLine() : 한 라인만 읽어온다. (BufferedReader 메서드) - void
		 * newLine() : 라인 구분자(개행문자)를 출력한다. (BufferedWriter 메서드)
		 */
