...
//		a.method3();
	...
	/*
	 * IntConsumer : int 값을 받아 소비 LongConsumer : long 값을 받아 소비 DoubleConsumer :
	 * double 값을 받아 소비
	 * 
	 */
	public void method3() {
	...
	/*
	 * ObjIntConsumer<T> : T 객체와 int 값을 받아 소비 ObjLongConsumer<T> : T 객체와 long 값을 받아
	 * 소비 ObjDoubleConsumer<T> : T 객체와 double 값을 받아 소비
	 */
	public void method4() {
