...
//		a.method1();
	...
	public void method2() {
		...
		// 성별이 여자인 요소만 출력
		students.stream().distinct().filter(student -> student.getGender().equals("여자"))
				.forEach(student -> System.out.println(student));
		
		System.out.println();
		
		// 수학 점수는 70점 이상, 영어 점수는 80점 이상인 요소만 출력
		students.stream().distinct().filter(student -> student.getMath() >= 70 && student.getEnglish() >= 80)
		.forEach(System.out::println); //(student -> System.out.println(student));
