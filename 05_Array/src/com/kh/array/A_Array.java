...
public class A_Array {
	...
	public void method1() {
		...
		/*
		 * 기본 자료형 : 스택 메모리에 생성된 공간에 실제 변수값을 저장
		 * 참조 자료형 : 실제 데이터 값은 힙 메모리에 저장하고, 스택 메모리의 변수 공간에는 실제 변수값이 저장된 힙 메모리의 주소값 저장
		 */
		System.out.println(score); //[I@3d012ddd

		/*
		 * - 배열을 생성하고 초기화 해주지 않아도 문제없이 출력!
		 * - JVM이 지정한 기본값으로 배열이 초기화 (정수형 : 0, 실수형 : 0.0, 문자형 : \u0000, 논리형 : false, 참조형 : null)
		 */
		//초기화!
		score[0] = 100;
		score[1] = 90;
	...
	public void method3() {
		...
		/*
		 * 향상된 for문
		 * - 자바5 부터 배열 및 컬렉션 클래스를 좀 더 쉽게 처리할 목적으로 제공
	...
	public void method4() {
		...
		double[] height = new double[3]; //배열 3개
		double sum = 0.0;
	...
	public void method5() {
		...
		System.out.println(num.hashCode()); // 객체를 식별할 하나의 정수
