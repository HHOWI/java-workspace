...
public class C_Sorting {
	...
	public void method3() {
		...
		System.out.println(copy[0] + " " +copy[copy.length-1]);		
	}
	/*
	 * 선택정렬(selection sort)
	 * - 가장 작은 데이터를 선택해 맨 앞에 있는 데이터와 바꾸고, 그 다음 작은 데이터를 선택해 앞에서 두 번째 데이터와 바꾸는 과정을 반복
	 * - 배열을 전부 담색하여 최소값을 고르고 왼쪽부터 채워나가는 방식의 정렬
	 ...
	 * - 구현이 쉽다는 장점이 있지만, 다른 정렬에 비해 속도가 느리며, 역순으로 정렬시 가장 느림
	 * 
	 * 7, 5, 9, 0, 3, 1, 6, 2, 4, 8
	 * 5, 7, 0, 3, 1, 6, 2, 4, 8, 9
	 * 5, 0, 3, 1, 6, 2, 4, 7, 8, 9
