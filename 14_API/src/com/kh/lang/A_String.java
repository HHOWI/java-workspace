...
//		a.method4();
	...
	public void method2() {
		...
		// 2. concat(String str) : String - 전달받은 문자열과 원본 문자열을 하나로 합친 새로운 문자열을 생성해서 리턴한다.
		...
		// 3. substring(int beginIndex) : String - 문자열의 beginIndex 위치에서부터 끝까지의 문자열을 새로 생성해서 리턴
		// 		substring(int beginIndex, int endIndex) : String - 문자열의 beginIndex 위치에서부터 endIndex -1 까지의 새로운 문자열을 생성해서 리턴
		...
		// 4. indexOf(String str) : int - 전달받은 str의 시작 인텍스를 리턴
		//		intdexOf(char ch) : int - 전달받은 ch의 인덱스를 리턴 
		...
		// 5. replace(char oldChar, char newChar) : String - 문자열에서 old 문자를 new 문자로 변경된 새로운 문자열을 생성해서 리턴
		String str6 = str.replace('l', 'c');
		System.out.println("str6 : " + str6);
				
		System.out.println();
		
		// 6. toUpperCase() / toLowerCase() : String - 문자열을 모두 대/소문자로 변경한 새로운 문자열을 생성해서 리턴
		...
		// 7.trim() : String - 문자열의 앞 뒤 공백을 제거한 새로운 문자열을 생성해서 리턴
		str = "              Hello, World!                   ";
		...
		// 8. toCharArray() : char[] - 문자열의 문자들을 문자 배열에 담아서 해당 배열의 주소값 리턴
		char[] arr = str.toCharArray();
		System.out.println(Arrays.toString(arr));
		
		// 9. static valueOf([기본 자료형, 문자 배열, 객체]) : String - 정적 메서드는 매개변수로 입력받는 값들을 문자열로 변경해서 리턴
	 ...
	 * - StringBuilder와 StringBuffer의 차이점 : 동기화 유무 
	...
	public void method3() {
		...
		System.out.println("sb3의 버퍼의 크기 : " + sb3.capacity());// 21
	...
	public void method4() {
		...
		// 2. insert(int offset, String str) : StringBuilder - 문자열의 offset 위치부터 전달받은 문자열을 추가
		sb.insert(1, "eeeee");
		System.out.println("insert : " + sb);
		
		// 3. delete(int start, int end) : StringBuilder - start에서 end -1 까지의 인덱스에 해당하는 문자열을 삭제
		sb.delete(1, 6);
	...
	public void method5() {
		...
		// split(Sting regex) : 입력받은 구분자로 문자열을 분리해서 문자열의 배열로 담아서 리턴
