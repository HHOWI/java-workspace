...
public class Application {
	...
	/*
	 * 객체 : 실제로 존재하는 것. 사물과 같은 유형적인 것 뿐만 아니라, 개념이나 논리와 같은 무형적인 것도 포함.
	 * 
	 ...
	 * 2. 캡슐화 : 객체의 속성(필드) 기능(메소드)을 하나로 묶고 실제 구현 내용을 감추는 것
	 * 3. 상속 : 하나의 객체가 가지고 있는 속성(필드)과 기능(메소드)를 다른 객체가 물려받는 것
	 * 4. 다형성 : 같은 타입이지만 실행 결과가 다양한 객체를 이용할 수 있음
	 * 
	 * 클래스
	 ...
	 * - 클래스 작성 시 객체 지향 언어의 특징 중 추상화(Abstraction), 캡슐화(Encapsulation)가 적용되어야 함
	 */
	...
	public static void main(String[] args) {
		...
		tv.channelUp();
		System.out.println("TV 채널 : " + tv.channel); // 1
		tv.channelDown();
		tv.channelUp();
		System.out.println("TV 채널 : " + tv.channel); // 1
	}
