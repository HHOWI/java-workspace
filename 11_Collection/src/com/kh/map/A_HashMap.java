...
//		a.method1();
	...
	public void method1() {
		...
		/*
		 * 4. entrySet() 메서드 - Map 컬렉션에 있는 Entry 객체(key, value 쌍으로 이루어진)를 Set 컬렉션에 담아서
		 * 반환
		 */
...
//		}	
	...
	public void method2() {
		...
		System.out.println("홈런볼의 정보 : " + snack2);
		...
		for (Entry<String, Snack> entry : entrySet) {
			if (entry.getValue().getFlavor().contains("딸기")) {
				calorie += entry.getValue().getCalorie();
				count++;
			}
		}
		System.out.println("딸기가 포함된 과자들의 평균 칼로리 : " + calorie / count);
